...
const Footer = ({ forceShow = false }) => {
    ...
    return (
        <div className={`footer-scaler-outer ${forceShow ? 'force-show' : ''}`}>
                        ...
                        <div className="footer-section contact-section">
                            ...
                            <div className="contact-info">
                                ...
                                <div className="contact-text">
                                    <p className="p-reset">1/344, Kathauta Chauraha, Gomtinager, Lucknow, UP (226010)</p>
                                </div>
                            </div>
                            <div className="contact-info">
                                <div className="contact-icon">📞</div>
                                <div className="contact-text">
                                    <p className="p-reset"><a href="tel:+919622609424">+91 96226-094-24</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
